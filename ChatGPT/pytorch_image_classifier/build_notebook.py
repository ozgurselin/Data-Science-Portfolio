...
**Assignment:** incrementally generate and execute an image-classification pipeline, add training-accuracy plots, and submit a notebook, HTML rendering, and dialogue summary.
